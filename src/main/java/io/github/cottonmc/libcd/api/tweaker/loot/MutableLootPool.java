...
public class MutableLootPool {
    ...
    public MutableLootPool(class_55 pool) {
    ...
    public MutableLootPool removeEntry(String type, String name) {
        ...
        for (JsonElement elem : getEntries()) {
            if (elem instanceof JsonObject) {
                ...
                String objType = class_3518.method_15253(obj, "type", "");
                String objName = class_3518.method_15253(obj, "name", "");
    ...
    private JsonArray getEntries() {
        ...
        return class_3518.method_15292(poolJson, "entries", new JsonArray());
    }
    ...
    private JsonArray getConditions() {
        ...
        return class_3518.method_15292(poolJson, "conditions", new JsonArray());
    }

    public class_55 get() {
        return Gsons.LOOT_TABLE.fromJson(poolJson, class_55.class);
    }
}
