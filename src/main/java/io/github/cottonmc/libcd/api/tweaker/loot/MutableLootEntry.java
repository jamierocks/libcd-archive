...
public class MutableLootEntry {
	...
	public MutableLootEntry(class_79 entry) {
	 ...
	 */
	public MutableLootEntry addFunctions(class_117... functions) {
	...
	private JsonArray getConditions() {
		...
		return class_3518.method_15292(entryJson, "conditions", new JsonArray());
	}
	...
	private JsonArray getFunctions() {
		...
		return class_3518.method_15292(entryJson, "functions", new JsonArray());
	}
	...
	private JsonArray getChildren() {
		...
		return class_3518.method_15292(entryJson, "children", new JsonArray());
	}
	...
	public class_79 get() {
		return Gsons.LOOT_TABLE.fromJson(entryJson, class_79.class);
	}
}
