...
public class MutableLootTable {
	...
	public MutableLootTable(class_52 table) {
	 ...
	 */
	public MutableLootTable addFunctions(class_117... functions) {
	...
	private JsonArray getPools() {
		...
		return class_3518.method_15292(tableJson, "pools", new JsonArray());
	}
	...
	private JsonArray getFunctions() {
		...
		return class_3518.method_15292(tableJson, "functions", new JsonArray());
	}

	public class_52 get() {
		return Gsons.LOOT_TABLE.fromJson(tableJson, class_52.class);
	}
}
